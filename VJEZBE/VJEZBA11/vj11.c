...
// Struktura za ?vor vezane liste država
...
// Funkcija za preslikavanje klju?a
...
// Funkcija za pretragu gradova odre?ene države s brojem stanovnika ve?im od zadane vrijednosti
...
int main() {
    ...
    while (fscanf(datoteka_drzave, "%s %s", naziv_drzave, datoteka_gradovi) == 2) {
        ...
        // ?itanje gradova iz datoteke i dodavanje u stablo
        ...
        // Povezivanje stabla gradova s odgovaraju?om državom
    ...
    // Pretraga gradova odre?ene države
